...
# 注释掉说话人验证文件初始化，因为用户不需要此功能
reg_spks_files = []
# reg_spks_files = ["api4sensevoice/speaker/speaker1_a_cn_16k.wav"]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--port", type=int, default=8102, help="Port number to run the FastAPI app on."
    )
